...
parser.add_argument('--INPUT_DIR', type=str, default=r'/project/ece/roysam/lbai/output/reconstruction/registered',
                    help='/project/ece/roysam/lbai/output/reconstruction/registered')
parser.add_argument('--OUTPUT_DIR', type=str, default=r'/project/ece/roysam/lbai/output/classification',
                    help='/project/ece/roysam/lbai/output/classification')
parser.add_argument('--BBXS_FILE', type=str, default='/project/ece/roysam/lbai/output/detection/bbxs_detection.txt',
                    help='/project/ece/roysam/lbai/output/detection/bbxs_detection.txt')
