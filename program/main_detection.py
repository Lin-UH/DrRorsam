...
parser.add_argument('--INPUT_DIR', type=str, default=r'/project/ece/roysam/lbai/output/reconstruction/inter_corrected', help='/path/to/input/dir')
parser.add_argument('--OUTPUT_DIR', type=str, default=r'/project/ece/roysam/lbai/output/inter-detection', help='/path/to/output/dir')
parser.add_argument('--DAPI', type=str, default='R2C1.tif', help='/path/to/dapi.tif | None')
parser.add_argument('--HISTONES', type=str, default='R2C2.tif', help='/path/to/dapi.tif | None')
